...
module.exports.defaultTolerance = 5;
module.exports.fourBandThresholdTolerance = 5;
...
module.exports = function encode(value, tolerance) {
    tolerance = tolerance || module.exports.defaultTolerance;
    ...
    if(tolerance >= module.exports.fourBandThresholdTolerance) {
